...
if ( ! class_exists( 'Storefront_Customizer' ) ) :
	...
	class Storefront_Customizer {
		...
		public function customize_register( $wp_customize ) {
			...
			$wp_customize->get_section( 'background_image' )->title    = __( 'Background', 'noakirel' );
			$wp_customize->get_section( 'background_image' )->priority = 30;

			// Change header image section title & priority.
			$wp_customize->get_section( 'header_image' )->title    = __( 'Header', 'noakirel' );
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_heading_color',
					array(
						'label'    => __( 'Heading color', 'noakirel' ),
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_accent_color',
					array(
						'label'    => __( 'Link / accent color', 'noakirel' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_hero_heading_color',
					array(
						'label'    => __( 'Hero heading color', 'noakirel' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_hero_text_color',
					array(
						'label'    => __( 'Hero text color', 'noakirel' ),
						'section'  => 'storefront_typography',
			...
			$wp_customize->add_control(
				new Arbitrary_Storefront_Control(
					...
					array(
						...
						'type'     => 'heading',
						'label'    => __( 'Header background image', 'noakirel' ),
						'priority' => 6,
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_header_background_color',
					array(
						'label'    => __( 'Background color', 'noakirel' ),
						'section'  => 'header_image',
			...
			$wp_customize->add_section(
				'storefront_footer',
				array(
					'title'       => __( 'Footer', 'noakirel' ),
					'priority'    => 28,
					'description' => __( 'Customize the look & feel of your website footer.', 'noakirel' ),
				)
			);
			...
			$wp_customize->add_section(
				'storefront_buttons',
				array(
					'title'       => __( 'Buttons', 'noakirel' ),
					'priority'    => 45,
					'description' => __( 'Customize the look & feel of your website buttons.', 'noakirel' ),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_button_alt_background_color',
					array(
						'label'    => __( 'Alternate button background color', 'noakirel' ),
						'section'  => 'storefront_buttons',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'storefront_button_alt_text_color',
					array(
						'label'    => __( 'Alternate button text color', 'noakirel' ),
						'section'  => 'storefront_buttons',
			...
			$wp_customize->add_control(
				new Storefront_Custom_Radio_Image_Control(
					...
					array(
						...
						'label'    => __( 'General Layout', 'noakirel' ),
						'priority' => 1,
						'choices'  => array(
			...
			if ( apply_filters( 'storefront_customizer_more', true ) ) {
				...
				$wp_customize->add_control(
					new More_Storefront_Control(
						...
						'storefront_more',
						array(
							'label'    => __( 'Looking for more options?', 'noakirel' ),
